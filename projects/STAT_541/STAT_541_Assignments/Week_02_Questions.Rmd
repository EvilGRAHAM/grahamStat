...
## 2.07
### a.
With an odds ratio, we aren't directly measuring the probability of an event, merely its odds. The correct iterpretation would be the odds of a female surviving is 11.4 times that of a male.
